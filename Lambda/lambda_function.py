...
def recommend_portfolio(intent_request):
    ...
    """
    Validates the age to be 65 and older and the investment amount to be 5000 and higher.
    """
    def validate_data(age, investment_amount, intent_request):
    # Validate the age, it should be > 0 and less than 65
        if age is not None:
            age = parse_int(
                age
            )  
            if age >= 65:
                return build_validation_result(
                    False,
                    "age",
                    "This portfolio is intented for people to prepare investment portfolio for their retirement before the age of 65."
                    "For comparison, you may enter the age when you purchased your current portfolio",
                )
            if age <= 0:
                return build_validation_result(
                    False,
                    ...
                    "It can be any number that is greater than 0",
                )
